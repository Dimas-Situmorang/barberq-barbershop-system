...
MONGODB\_URI=mongodb://127.0.0.1:27017/barberq
...
NEXT\_PUBLIC\_DATA\_SOURCE=api

NEXT\_PUBLIC\_API\_BASE\_URL=http://localhost:4000/api

```



Pastikan `NEXT\_PUBLIC\_DATA\_SOURCE` menggunakan:
